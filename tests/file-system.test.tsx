...
import { assertNotNull as v } from '@/utils';
...
describe('useFileSystemStore', () => {
  ...
  it('should create a nested folder', () => {
    act(() => {
      ...
      const folder2Id = v(
        store.createEntry({
          parentId: v(store.getId('folder1')),
          type: 'directory',
          name: 'folder2',
        }),
      );
      ...
      const folder3Id = v(
        store.createEntry({
          parentId: v(store.getId('folder2')),
          type: 'directory',
          name: 'folder3',
        }),
      );
      ...
      const folder4Id = v(
        store.createEntry({
          parentId: v(store.getId('folder3')),
          type: 'directory',
          name: 'folder4',
        }),
      );
  ...
  it('it should copy a directory', () => {
    act(() => {
      ...
      const folderCopyFileId = folderCopyChildren.find((id) => store.getEntry(id)?.type === 'file');
